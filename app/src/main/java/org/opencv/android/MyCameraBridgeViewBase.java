...
public abstract class MyCameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected int mPreviewFormat = Videoio.CV_CAP_ANDROID;
    ...
    protected class CvCameraViewListenerAdapter implements MyCameraBridgeViewBase.CvCameraViewListener2  {
        ...
        public Mat onCameraFrame(MyCameraBridgeViewBase.CvCameraViewFrame inputFrame) {
            ...
            switch (mPreviewFormat) {
                case Videoio.CV_CAP_MODE_RGB:
                    result = mOldStyleListener.onCameraFrame(inputFrame.rgb());
                    break;
                case Videoio.CV_CAP_ANDROID:
                    result = mOldStyleListener.onCameraFrame(inputFrame.rgba());
                    break;
                case Videoio.CV_CAP_MODE_GRAY:
        ...
        private int mPreviewFormat = Videoio.CV_CAP_ANDROID;
